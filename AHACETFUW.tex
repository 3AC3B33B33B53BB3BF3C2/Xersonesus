...
\entry{Chomsky, Noam} {} {} {Chomsky is one of the linguists whose theories on the structure of language (i.e., syntax) contributed little to nothing at all to development of the large language models required for the breakthrough in Artificial Intelligence witnessed with OpenAI's release of ChatGPT (during the Ukraine war).\footnote{ChatGPT marked a major turning point in the history of the development of AI.} No computer scientist, for instance, utilizes the \emph{Minimalist Program} for parsing natural language sentences. In his own turn, Chomsky described associated the responses ChatGPT produces with "glorified autocorrection," disputing the idea that AI generates grammatically sound sentences.\footnote{The fact that ChatGPT generates grammatically sound sentences literally obliterates Chomsky's theory of 'innateness' (i.e., Cartesian dualism) since there is no consciousness associated with ChatGPT.} Computer scientists have utilized a wide range of different linguistic theories for natural language processing (which used to be its own subject of study in academia but has since become subordinated to the study of AI). \newline \indent Chomsky's role in the area of politics presented intellectuals with the opportunity to represent the left but without political economy. \newline \indent The U.S. agencies 
}
