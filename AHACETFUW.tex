...
Together with currency, trade routes, coal, gas, and oil, one of the primary causes of the Ukraine war is a result of the ever intensifying competition among the great powers, whose pursuit of raw materials and drive for access to, control over, or exploitation of those materials in the Ukraine clashes with the world economy. No longer independent economic units, the collapsed but powerful nations and states are interlocked into a powder keg of contradictions whose resolution cannot but lead to an explosion of the present war into an global conflagration on a scale hitherto-fore unknown to mankind.

% Rare earths, one of the most precious raw materials, is a case in point.   
